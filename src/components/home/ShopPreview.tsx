...
export const ShopPreview = () => {
  ...
  const productsData = content?.explore?.products || {
    ...
    tilapia: {
      ...
      subtitle: "Sustainably farm-raised...",
      features: [],
  ...
  const productCategories = [
    {
      id: "tilapia",
      ...productsData.tilapia,
      whatsappMessage: "Hello, I'm interested in ordering fresh tilapia fish",
      image: "https://www.globalseafood.org/wp-content/uploads/2018/12/STONEHAM-tilapia-Pic-0.jpg"
    },
    {
      id: "nilePerch",
      ...productsData.nilePerch,
      whatsappMessage: "Hello, I'm interested in Nile Perch",
      image: "https://a-z-animals.com/media/2022/06/shutterstock_2100233851-1024x614.jpg"
    }
  ];
  
  const currentProduct = productCategories.find(p => p.id === activeCategory) || productCategories[0];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`order-2 md:order-1 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <WhatsAppButton 
                text={currentProduct.buttonText}
                phoneNumber="+255755823336"
                message={currentProduct.whatsappMessage}
