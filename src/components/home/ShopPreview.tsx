...
const ShopPreview = () => {
  ...
  const productsData = content?.explore?.products || {
  ...
  const productCategories = [
    {
      id: "tilapia",
      name: productsData.tilapia.title,
      description: productsData.tilapia.subtitle,
      buttonText: productsData.tilapia.buttonText,
      whatsappMessage: "Hello, I'm interested in ordering fresh tilapia fish, my name is ",
      image: productsData.tilapia.image || "https://www.globalseafood.org/wp-content/uploads/2018/12/STONEHAM-tilapia-Pic-0.jpg",
      features: productsData.tilapia.features
    },
    {
      id: "nilePerch",
      name: productsData.nilePerch.title,
      description: productsData.nilePerch.subtitle,
      buttonText: productsData.nilePerch.buttonText,
      whatsappMessage: "Hello, I'm interested in Nile Perch, my name is ",
      image: productsData.nilePerch.image || "https://a-z-animals.com/media/2022/06/shutterstock_2100233851-1024x614.jpg",
      features: productsData.nilePerch.features
    }
  ];

  // Get the current category
  const activeProduct = productCategories.find(c => c.id === activeCategory) || productCategories[0];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`order-2 md:order-1 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <WhatsAppButton 
                  text={activeProduct.buttonText}
                  phoneNumber="+255755823336"
                  message={activeProduct.whatsappMessage}
