...
const Contact = () => {
  ...
  const contactData = content?.contact || {
    subtitle: "Have questions about our fish products...",
    general: {
      subtitle: "For general questions about Nane Nane...",
      email: "mohammedatul7@gmail.com",
      phone: "+255 755 823 336",
      address: "Lake Victoria, Mwanza Region, Tanzania"
    },
    orders: {
      subtitle: "For inquiries related to our fish products...",
      email: "mohammedatul7@gmail.com",
      salesPhone: "+255 755 823 336",
      orderProcess: "Orders can be placed directly...",
      deliveryInfo: "For bulk orders or special requirements..."
    },
    location: {
      subtitle: "Located on the shores of Lake Victoria...",
      address: "Lake Victoria, Mwanza Region, Tanzania",
      directions: "Contact us for detailed directions..."
    }
  };
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">{contactData.general.email}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">{contactData.general.phone}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">{contactData.general.address}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            <p className="font-medium text-gray-900">Email</p>
                            <p className="text-gray-700">{contactData.orders.email}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">{contactData.orders.salesPhone}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-8">
                        ...
                        <p className="text-gray-700 mb-4">
                          {contactData.orders.orderProcess}
                        </p>
                        <p className="text-gray-700">
                          {contactData.orders.deliveryInfo}
                        </p>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Address</p>
                        <p className="text-gray-700">{contactData.location.address}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">{contactData.location.directions}</p>
                      </div>
                    </div>
                  </div>
